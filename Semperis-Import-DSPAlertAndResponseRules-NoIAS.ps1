...
.NOTES
    ...
    Updates: 
        2026-01-21 - Removed IAS and Entra Capabilities - Customized. 
        2025-08-22 - Changed Entra ID/IAS logic checl
...
elseif($Mode -eq "import"){
    ...
    elseif($Type -eq "EntraID"){
        ...
        Write-Host " - This is a custom script. Please use original script for Entra ID rules."
